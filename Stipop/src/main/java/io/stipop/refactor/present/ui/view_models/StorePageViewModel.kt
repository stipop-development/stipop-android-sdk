...
class StorePageViewModel @Inject constructor(
    ...
    private val _storeAllPackageListPageMap: MutableLiveData<PageMap?> = MutableLiveData()

    private val _storeSearchPackageList: MutableLiveData<List<SPPackage>> = MutableLiveData()
    private val _storeSearchPackageListPageMap: MutableLiveData<PageMap?> = MutableLiveData()
...
class StorePageViewModel : ViewModel() {
    ...
    private val _searchPageMap: MutableLiveData<PageMap?> = MutableLiveData()
    ...
    private val _allPageMap: MutableLiveData<PageMap?> = MutableLiveData()
...
//                                // haptics
//                                val vibrator =
//                                    this.root.context.getSystemService(Context.VIBRATOR_SERVICE) as Vibrator
